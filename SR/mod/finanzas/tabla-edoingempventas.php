...
//echo $xml;
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact nowrap' cellspacing='0' style='width:100%;'><tfoot><tr><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot></table></div>"; 
...
/*
 ...
 $(document).ready(function() {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_total.column( 5 ).footer() ).html(numFormat(total_total) );
