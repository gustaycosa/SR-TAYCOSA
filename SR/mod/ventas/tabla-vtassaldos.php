   ...
   $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                ...
                { 'title': 'SALDO X APLICAR', className: "text-right", 'targets': 3},
                { 'title': 'SALDO TOTAL',className: "text-right", 'targets': 4},
                { 'title': 'SALDO NORMAL', className: "text-right", 'targets': 5},
                { 'title': 'SALDO VENCIDO', className: "text-right", 'targets': 6},
                { 'title': '1-7',className: "text-right", 'targets': 7},
                { 'title': '8-15', className: "text-right", 'targets': 8},
                { 'title': '16-23', className: "text-right", 'targets': 9},
                { 'title': '24-30', className: "text-right", 'targets': 10},
                { 'title': '31 Y MAS', className: "text-right", 'targets': 11}
            ],
...
/*                $(row).attr({ id:data.id_Vendedor});
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_once.column( 10 ).footer() ).html(numFormat(total_once) );
            //===========================================================================
            ...
            // Update footer
            $( api_mesact.column( 11 ).footer() ).html(numFormat(total_mesact) );
