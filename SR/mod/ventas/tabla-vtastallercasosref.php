...
try{ 
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='griddet' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style='width:100%;'><tfoot><tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot></table></div>";
	$arreglo = [];
...
//                $(row).addClass('vendedor');
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_facturado.column( 3 ).footer() ).html(numFormat(total_facturado) );
            ...
            // Update footer
            $( api_descuentos.column( 4 ).footer() ).html(numFormat(total_descuentos) );   
            ...
            // Update footer
            $( api_devolucion.column( 6 ).footer() ).html(numFormat(total_devolucion) );      
            ...
            // Update footer
            $( api_drefacturacion.column( 7 ).footer() ).html(numFormat(total_drefacturacion) );   
            ...
            // Update footer
            $( api_garantianore.column( 8 ).footer() ).html(numFormat(total_garantianore) ); 
/*
            $("#TotalFac").empty();
