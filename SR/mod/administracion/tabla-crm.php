...
/*
 ...
 $(document).ready(function() {
         var table = $('#grid').DataTable({
            ...
            columnDefs: [
                { 'title': 'CASO', className: "text-left", 'targets': 0},
                { 'title': 'FECHA', className: "text-left", 'targets': 1},
                { 'title': 'CLIENTE', className: "text-left", 'targets': 2},
                { 'title': 'GENERA', className: "text-left", 'targets': 3},
                { 'title': 'TIPO', className: "text-left", 'targets': 4},
                { 'title': 'DESCRIPCION', className: "text-left", 'targets': 5},
                { 'title': 'ESTATUS', className: "text-left", 'targets': 6}
            ],
