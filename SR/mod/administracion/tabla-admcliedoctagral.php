...
echo "<div class='table-responsive'><table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style='width:100%;' ><tfoot><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tfoot></table></div>";
...
$(document).ready(function() {
       ...
       "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_anoant.column( 14 ).footer() ).html(numFormat(total_anoant) );
            ...
            // Update footer
            $( api_anoact.column( 13 ).footer() ).html(numFormat(total_anoact) );
            ...
            // Update footer
            $( api_utilper.column( 11 ).footer() ).html(numFormat(total_utilper) );
            ...
            // Update footer
            $( api_inggen.column( 9 ).footer() ).html(numFormat(total_inggen) );
            ...
            // Update footer
            $( api_promen.column( 8 ).footer() ).html(numFormat(total_promen) );
