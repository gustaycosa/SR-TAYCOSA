...
try{ 
  ...
  var_dump($e);
    ...
    echo "<div class='table-responsive'>
        <table id='grid' class='table table-striped table-bordered table-condensed table-hover display compact' cellspacing='0' style='width:100%;' ><tfoot><tr><th></th><th></th><th></th><th></th><th></th><th></th><th></th></tr></tfoot></table></div>";
...
/*
   ...
   $(document).ready(function() {
        ...
        "footerCallback": function ( row, data, start, end, display ) {
            ...
            $( api_ref.column( 1 ).footer() ).html(numFormat(total_ref) );
            $( api_maq.column( 2 ).footer() ).html(numFormat(total_maq) );
            $( api_cont.column( 3 ).footer() ).html(numFormat(total_cont) );
            $( api_mo.column( 4 ).footer() ).html(numFormat(total_mo) );
            $( api_mop.column( 5 ).footer() ).html(numFormat(total_mop) );
            $( api_tra.column( 6 ).footer() ).html(numFormat(total_tra) );
            ...
            /*
            $("#lbltotal").empty();
            $("#lbltotal").append('COMISIONES TOTALES REF = $' + total_ref) + '-> COBRADO = $'+ totalCobrado) +' -> COMISION RECEPCION = $' + totalRecepcion));
            */
